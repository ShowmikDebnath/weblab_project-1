...
<body>
  <nav class="navbar navbar-light justify-content-center fs-3 mb-5" style="background-color: #CFE2FF;">
    Admin Panal - Student info
  </nav>
  ...
  <button class="btn btn-primary" type="button">Logout</button></div></a>
